...
int main() {
    ...
    ThinLensCamera cam(Vec3(0, 0, 1), Vec3(0, 0, -1), Vec3(0, 0, -3), 1, 0.2);
    ...
    aggregate.add(std::make_shared<Sphere>(Vec3(3, 0, -5), 1, mat2, light1));
    aggregate.add(std::make_shared<Sphere>(Vec3(-2, 0, -2), 1, mat2, light1));
    ...
    SaveBitmap("use_thinlens.bmp", img);
